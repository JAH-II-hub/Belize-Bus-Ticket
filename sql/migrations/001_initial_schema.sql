-- Belize Bus Ticket System - Initial Schema Migration
-- Version: 1.0.0
-- Description: Complete database schema creation for the Belize Bus Ticket System
...
DROP TABLE IF EXISTS teller_sales;
...
CREATE TABLE users (
    ...
    user_type ENUM('Admin', 'Customer', 'Teller') NOT NULL,
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
